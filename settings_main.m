...
cfg.rating.items = { ...
    struct('type','mcq','name','familiar', 'question','Are you familiar with the food item?', ...
           'options',{{'Yes','No'}}), ...
    struct('type','mcq','name','eaten', 'question','Have you ever eaten the food item?', ...
           'options',{{'Yes','No'}}), ...
    struct('type','mcq','name','calory', 'question','Do you consider the food item high or low-calory?', ...
           'options',{{'High-calory','Low-calory'}}), ...
    struct('type','mcq','name','processed', 'question','Do you consider the food item processed or unprocessed/natural?', ...
           'options',{{'Processed','Natural'}}), ...
    struct('type','mcq','name','colour', 'question','In terms of colour, do you consider the food item to be ...', ...
           'options',{{'Predominantly red','Predominantly green/blue','Particularly colourful','Particularly colourless','None of the above'}}), ...

    struct('type','vas','name','arousal_video','question','How arousing was the video?', ...
           'anchors',{{'Not at all','Very'}}, 'image','arousal'), ...
    struct('type','vas','name','arousal_sound','question','How arousing was the sound?', ...
           'anchors',{{'Not at all','Very'}}), ...
    struct('type','vas','name','pleasant_video','question','How pleasant was the video?', ...
           'anchors',{{'Not at all','Very'}}, 'image','valence'), ...
    struct('type','vas','name','pleasant_sound','question','How pleasant was the sound?', ...
           'anchors',{{'Not at all','Very'}}), ...

    struct('type','vas','name','fulfillment','question','How much fulfillment/satisfaction did this video cause?', ...
           'anchors',{{'Very unsatisfied','Very satisfied'}}), ...
    struct('type','vas','name','fear','question','How much fear did this video cause?', ...
           'anchors',{{'Very fearful','Very fearless'}}), ...
    struct('type','vas','name','guilt','question','How much guilt did this video cause?', ...
           'anchors',{{'Very guilty','Very unguilty'}}), ...
    struct('type','vas','name','shame','question','How much shame did this video cause?', ...
           'anchors',{{'Very ashamed','Very unashamed'}}), ...
    struct('type','vas','name','anger','question','How much anger did this video cause?', ...
           'anchors',{{'Very angry','Very peaceful'}}), ...
    struct('type','vas','name','disgust','question','How much disgust did this video cause?', ...
           'anchors',{{'Very disgusted','Very delighted'}}), ...
    struct('type','vas','name','health','question','How healthy do you think the item is?', ...
           'anchors',{{'Very unhealthy','Very healthy'}}), ...
    struct('type','vas','name','want_eat','question','How much would you like to eat the food item you saw?', ...
...
cfg.text.getready_pt       = 'A experi�ncia come�ar� em breve... Mantenha o olhar fixo na cruz';
...
cfg.text.baselineOpen_pt   = 'O per�odo de relaxamento com olhos abertos come�ar� em breve';
...
prompt={'Introduza o ID do participante',...
    'Linguagem da tarefa','Indique o n�mero da sess�o (run)'};
dlg_title='Input';
